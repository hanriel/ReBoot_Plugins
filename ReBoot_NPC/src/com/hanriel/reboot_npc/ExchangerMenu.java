...
public class ExchangerMenu implements Listener {
    ...
    public ExchangerMenu(String name, int size, OptionClickEventHandler handler, Plugin plugin) {
        this.name = name;
        this.size = size;
    ...
    public ExchangerMenu setOption(int position, ItemStack itemStack) {

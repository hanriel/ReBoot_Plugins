package com.hanriel.reboot_gui;
...
import com.hanriel.reboot_core.Log;
...
public class GUI extends JavaPlugin {
    ...
    public void onEnable() {
        try {
            ...
            Log.info("The " + getName() +" was successfully loaded!" + plugin.getDescription().getVersion());
        } catch (Exception e) {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String alias, String[] args)
    {
        ...
        if ((cmd.getName().equalsIgnoreCase("quest"))) {
            ...
            if (args.length == 1){
                ((Player)sender).setMetadata("m", new FixedMetadataValue(Core.getInstance(), args[0]));
            }
        }

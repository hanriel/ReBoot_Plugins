package com.skyandforest.reboot_auth.nms;
	...
	public static boolean setup() {
		...
		if (Utils.isClassLoaded("org.bukkit.inventory.ItemFlag")) {
			...
			try {
				...
				Shop.getInstance().getLogger().info("Could not enable the attribute remover for this version (" + e + "). Attributes will show up on items.");
			}
		}
